...
Cribbit is a shared-house Telegram bot with a responsive Telegram Mini App. Railway runs the bot, API, and persistent store. Vercel serves the landing page and Mini App. Native iOS and Android apps remain **Coming soon** until separately built and released.
...
- **WEB-009:** Outside Telegram, real house data remains inaccessible and an authentication gate is shown.
